                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h2 className="text-2xl font-black uppercase tracking-tight italic flex items-center gap-3">
                                Worker Tracking
                                <span className="text-sm bg-accent-amber/10 text-accent-amber px-3 py-1 rounded-full font-bold">{workers.length} Active</span>
                            </h2>
                    ...
                    <div className="flex items-center gap-3">
                        <div className="flex items-center gap-1 bg-white/5 rounded-xl p-1">
                            ...
                            <button onClick={() => setView("map")} className={`px-3 py-1.5 rounded-md text-[11px] font-black uppercase tracking-widest transition-all ${view === "map" ? "bg-accent-amber/10 text-accent-amber shadow-[0_0_10px_rgba(245,158,11,0.1)]" : "text-white/35 hover:text-white/60"}`}>
