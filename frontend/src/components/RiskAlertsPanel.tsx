            ...
            <div className={`glass-card p-6 ${riskMiners.length > 0 ? "danger-pulse" : ""}`} style={{ borderColor: "rgba(239,68,68,0.2)" }}>
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
                    <div>
                        ...
                        <p className="text-accent-muted font-bold uppercase tracking-widest text-[10px] mt-1">Workers currently inside hazard zones — live simulation data</p>
                    </div>
                ...
                <div className="flex flex-wrap gap-4 mb-6">
                    <div className="flex items-center gap-2 px-3 py-2 rounded-xl bg-accent/10 border border-accent/20">
                        ...
                        <span className="text-sm font-bold text-accent uppercase tracking-widest">{riskMiners.length} IN HAZARD ZONE</span>
                    </div>
                    <div className="flex items-center gap-2 px-3 py-2 rounded-xl bg-accent-muted/10 border border-accent-muted/20">
                        ...
                        <span className="text-sm font-bold text-accent-muted uppercase tracking-widest">{safeMiners.length} Safe</span>
                    </div>
                    <div className="flex items-center gap-2 px-3 py-2 rounded-xl bg-white/5 border border-white/10">
                        <span className="text-sm font-bold text-white/60 uppercase tracking-widest">{simMiners.length} Total</span>
                    </div>
                            ...
                            <div key={log.id + i} className="p-3 rounded-xl bg-amber-400/5 border border-amber-400/10">
                                <div className="flex items-center justify-between mb-1">
                                    <span className="text-xs font-black uppercase tracking-widest text-accent flex items-center gap-1">
                                        <AlertTriangle className="w-3 h-3" /> ENTERED {log.zone}
                                    </span>
